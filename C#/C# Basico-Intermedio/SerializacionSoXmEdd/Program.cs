...
namespace SerializacionSoXmEdd
{
    class Program
    {
        static void Main(string[] args)
            {
                ...
                if (opcion == 1)
                {
                    ...
                    // se crea el stream
                    Stream miStream = new FileStream("SoapAutos.aut", FileMode.Create, FileAccess.Write, FileShare.None);
                ...
                if (opcion == 2)
                {
                    ...
                    SoapFormatter formateador = new SoapFormatter();
                    //creamos el stream
                    Stream miStream = new FileStream("SoapAutos.aut", FileMode.Open, FileAccess.Read, FileShare.None);
                    // deserializamos 
