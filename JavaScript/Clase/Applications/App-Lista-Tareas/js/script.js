    ...
    constructor(){
        ...
        if(!this.tareas){
            this.tareas = [
                ...
                {tarea: 'Aprender SQL',completado: false},
                {tarea: 'Aprender Python', completado: false},
                {tarea: 'Aprender Java', completado: true}
            ];
        ...
        <li class="list-group-item checkbox">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10 col-xs-10 col-lg-10 col-sm-10 texto-tarea ${tarea.completado ? 'tarea-completado' : ''}">
                        ${tarea.tarea}
                    </div>
